...
<div class="">    
    <div class="card">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.artikel.update', $artikel->id) }}">
            @csrf
            @method('PUT') <!-- Menambahkan metode PUT --><!-- Menambahkan metode PUT -->

                <div class="form-group">
                    <label for="judul">Judul Artikel</label>
                    <input value="{{ old('judul', $artikel->judul) }}" required type="text" name="judul" placeholder="Masukkan judul artikel" class="form-control"> 
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select required class="form-control" name="kategori_artikel_id">
                                ...
                                @foreach($kategoriArtikel as $kategori)
                                    <option value="{{ $kategori->id }}" {{ $kategori->id == $artikel->kategori_artikel_id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <textarea required name="deskripsi" id="deskripsi" class="text-dark form-control summernote">{{ old('deskripsi', $artikel->deskripsi) }}</textarea>
                </div>
        </div>
